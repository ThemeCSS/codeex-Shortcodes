<?php
    ...
    if ( $site == "youtube" ) : $src = 'http://www.youtube-nocookie.com/embed/'.$id.'?rel=0'; 
    elseif ( $site == "vimeo" ) : $src = 'http://player.vimeo.com/video/'.$id; 
    elseif ( $site == "dailymotion" ) : $src = 'http://www.dailymotion.com/embed/video/'.$id; 
    endif;
    ...
    $out = "<label>" . do_shortcode($content);
    $out .= "</label>";
